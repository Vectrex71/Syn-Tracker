      ...
      {isOpen && (
            ...
            <div className="p-3.5 rounded-xl bg-[#090d14]/80 border border-[#f472b6]/30 flex items-start gap-2.5 text-xs text-[#cbd5e1]">
              ...
              <div>
                ...
                <p className="text-[#94a3b8] leading-relaxed">
                  Opens the Visualizer Studio with animated audio spectrums, branding logos, and automatic 60 FPS recording.
                </p>
              </div>
            </div>
          )}
          ...
          {format === 'mp3' && (
            <div className="p-3.5 rounded-xl bg-[#090d14]/80 border border-white/10 space-y-2">
              <label className="text-[11px] font-bold text-[#94a3b8] uppercase tracking-wider block font-mono">
                MP3 Bitrate (Audio Quality)
              </label>
              <div className="grid grid-cols-3 gap-2">
                {[
                  { rate: 128, label: '128 kbps', desc: 'Compact' },
                  { rate: 192, label: '192 kbps (Standard)', desc: 'Balanced' },
                  { rate: 320, label: '320 kbps', desc: 'High Quality' },
                ].map((b) => (
                  <button
                    key={b.rate}
                    type="button"
            ...
            <div className="p-3.5 rounded-xl bg-[#090d14]/80 border border-white/10 flex items-start gap-2.5 text-xs text-[#cbd5e1]">
              ...
              <div>
                <p className="font-semibold text-[#fb923c] mb-1">
                  Multi-Track Stems ZIP Package ({song.channelsCount} Channels + Master Mix)
                </p>
                <p className="text-[#94a3b8] leading-relaxed">
                  Exports each individual channel of your song as an isolated, synchronized 16-bit WAV file along with the full master mix. Perfect for importing into DAWs like Ableton Live, Logic Pro, FL Studio, or Reaper for mixing, vocals, and mastering.
                </p>
              </div>
            </div>
          )}
            ...
            <div className="p-3.5 rounded-xl bg-[#090d14]/80 border border-white/10 flex items-start gap-2.5 text-xs text-[#cbd5e1]">
              ...
              <div>
                <p className="font-semibold text-[#34d399] mb-1">
                  8-Channel MOD Compatibility
                </p>
                <p className="text-[#94a3b8] leading-relaxed">
                  Your {song.channelsCount} channels are exported with the standardized Amiga <span className="font-mono text-[#f8fafc]">8CHN</span> tag. This module can be loaded, played, and edited with all 8 channels intact in classic tracker software (OpenMPT, MilkyTracker, Renoise) or modern Amiga players.
                </p>
              </div>
            </div>
          )}
        ...
        <div className="px-5 py-3.5 border-t border-[#23354a] bg-[#0b1017]/80 flex items-center justify-between">
          <div className="text-[11px] text-[#64748b] font-mono">
            Duration: <span className="text-[#cbd5e1]">{formattedDuration}</span> &bull; Channels: <span className="text-[#cbd5e1]">{song.channelsCount}</span>
          </div>
            ...
            >
              {isExporting ? (
                ...
                <>
                  ...
                  <span>
                    {format === 'mp3' ? 'Download MP3 Now' : format === 'wav' ? 'Download WAV Now' : format === 'stems' ? 'Download STEMS ZIP' : 'Download MOD File'}
                  </span>
                </>
              )}
            </button>
