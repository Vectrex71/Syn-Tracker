              ...
              <div className="flex items-center gap-2">
                ...
                <div className="inline-flex rounded-lg bg-slate-900 p-0.5 border border-slate-800 gap-1">
                  {[
                    ...
                    { id: 'vinyl', label: 'Vinyl LP', desc: '12″ Vinyl Record Sleeve with Grooves', icon: <Disc className="w-3 h-3" /> },
                    { id: 'cd', label: 'Audio CD', desc: 'CD Jewel Case with Optical Compact Disc', icon: <Disc2 className="w-3 h-3" /> },
                    { id: 'cassette', label: 'MC Cassette', desc: 'Cassette Tape with Artwork & Label', icon: <Disc3 className="w-3 h-3" /> },
                  ].map((m) => (
                    <button
                      key={m.id}
                      type="button"
