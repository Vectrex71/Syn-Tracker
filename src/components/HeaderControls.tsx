...
export const HeaderControls: React.FC<HeaderControlsProps> = ({
  ...
  return (
    <header className="relative z-[90] px-2 sm:px-3 py-1.5 flex flex-col gap-1 select-none glass-panel-header text-[#cbd5e1] overflow-visible">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2.5 shrink-0 min-w-0">
            ...
            <div>
              ...
              {isEditingName ? (
                ...
                <button
                  ...
                  className="flex items-center gap-1 mt-0.5 px-1 py-0.5 -ml-1 rounded hover:bg-white/5 group/rename cursor-pointer transition-all border border-transparent text-left max-w-[70px] sm:max-w-[100px] md:max-w-[120px] lg:max-w-[95px] xl:max-w-[150px]"
          ...
          <div className="flex items-center gap-0.5 sm:gap-1 bg-[#070b10]/65 backdrop-blur-sm p-0.5 sm:p-1 rounded-lg border border-[#1a2536]/80">
            ...
            >
              ...
              <span className={`hidden xl:inline ${isPatternLoop ? 'text-[#38bdf8]' : 'text-[#94a3b8]'}`}>
            ...
            >
              ...
              <span className={`hidden xl:inline ${isEditMode ? 'text-[#fb7185]' : 'text-[#94a3b8]'}`}>
        ...
        <div className="flex items-center gap-1 sm:gap-1.5 shrink-0">
          ...
          <div ref={dropdownRef} className="flex items-center p-0.5 sm:p-1 rounded-lg bg-[#070b10]/65 backdrop-blur-sm border border-[#1a2536]/80 gap-0.5 sm:gap-1 relative z-50">
            ...
            <div className="relative z-[100]">
              ...
              {openDropdown === 'open' && (
                <div 
                  className="absolute right-0 mt-2 w-72 rounded-xl bg-[#0c131e]/98 backdrop-blur-2xl border border-[#2d4059] py-1.5 z-[99999] text-xs text-[#cbd5e1] shadow-[0_20px_50px_rgba(0,0,0,0.95),0_0_25px_rgba(56,189,248,0.2)] divide-y divide-[#1e2c3d]"
                ...
                >
                  <div className="py-1">
                    ...
                    <button
                      ...
                      className="w-full px-3 py-2 flex items-center gap-2.5 text-left hover:bg-[#1b2636]/90 transition-colors font-medium cursor-pointer group"
                    >
                      <FolderOpen className="w-4 h-4 text-[#fbbf24] shrink-0 group-hover:scale-110 transition-transform" />
                      <div>
                        <div className="font-semibold text-[#f8fafc]">Open File...</div>
                        <div className="text-[10px] text-slate-400 font-mono">.trk, .mod, .sid, .syn, .prg, audio</div>
                      </div>
                    </button>
                  </div>
                  ...
                  <div className="py-1">
                    ...
                    <button
                      ...
                      className="w-full px-3 py-2 flex items-center gap-2.5 text-left hover:bg-[#1b2636]/90 transition-colors font-medium cursor-pointer group"
                    >
                      <HardDrive className="w-4 h-4 text-[#38bdf8] shrink-0 group-hover:scale-110 transition-transform" />
                      <div>
                        <div className="font-semibold text-[#f8fafc]">Browser Project Vault</div>
                        <div className="text-[10px] text-slate-400">Local offline saved projects</div>
                      </div>
                    </button>
                  </div>
                  ...
                  {onLoadDemo && (
                    <div className="py-1">
                      <button
                        ...
                        className="w-full px-3 py-2 flex items-center gap-2.5 text-left hover:bg-[#1b2636]/90 transition-colors font-medium cursor-pointer group"
                      >
                        <Disc className="w-4 h-4 text-[#34d399] shrink-0 group-hover:rotate-45 transition-transform" />
                        <div>
                          <div className="font-semibold text-[#f8fafc]">Load Demo: Space Debris</div>
                          <div className="text-[10px] text-slate-400">Classic Amiga 4-Channel Track</div>
                        </div>
                      </button>
                    </div>
                  )}
            ...
            >
              ...
              <span className="hidden xl:inline">Save / Export</span>
