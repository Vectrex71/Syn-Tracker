                ...
                <div className="mt-2 flex items-center justify-between bg-[#101b29] p-2.5 rounded-md border border-[#1e3046]">
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="text-[10px] text-[#94a3b8] mt-0.5">
                      Saved: {new Date(autoSaveSession.updatedAt).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', second: '2-digit' })} ({new Date(autoSaveSession.updatedAt).toLocaleDateString()}) • {autoSaveSession.channelsCount} Channels • {autoSaveSession.patternCount} Patterns
                    </div>
                  </div>
