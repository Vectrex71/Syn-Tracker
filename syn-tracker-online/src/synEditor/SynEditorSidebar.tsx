  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar pr-1 space-y-3.5 text-xs">
            ...
            <div className="bg-[#0e1624] p-3 rounded-xl border border-[#1e2d42] space-y-2">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <span className="text-[10px] text-slate-400 font-mono">Maximum volume without clipping</span>
                </div>
            ...
            <div className="bg-[#0e1624] p-3 rounded-xl border border-[#1e2d42] space-y-2.5">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <span className="text-[10px] text-slate-400 font-mono">Analog tape echo with damping &amp; stereo bounce</span>
                </div>
                <button
                  onClick={onApplyEcho}
        ...
        {/* ========================================================================= */}
        {/* TAB 4: SAMPLE MERGE & FUSION STUDIO */}
        {/* ========================================================================= */}
          ...
          <div className="space-y-3">
            <div className="bg-[#0e1624] p-3 rounded-xl border border-[#1e2d42] space-y-3">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <span className="text-[10px] text-slate-400 font-mono">
                    Combine two samples into a new sound (mix together or append sequentially)
                  </span>
                </div>
                <button
              ...
              <div className="grid grid-cols-2 gap-3 bg-[#090e17] p-2.5 rounded-lg border border-[#162232]">
                <div>
                  <span className="text-[10px] font-mono font-bold text-sky-400 block mb-1">SAMPLE A (Current Slot {activeSlot.toString().padStart(2, '0')}):</span>
                  ...
                  <div className="flex items-center justify-between mt-1.5 text-[10px] font-mono">
                    <span className="text-slate-400">Volume A:</span>
                ...
                <div>
                  <div className="flex items-center justify-between mb-1">
                    <span className="text-[10px] font-mono font-bold text-amber-400">SAMPLE B (Second Sound):</span>
                  ...
                  >
                    {secondSampleFileName && (
                      <option value="-1">📁 File: {secondSampleFileName}</option>
                    )}
                    {samples.map((s, idx) => (
                  ...
                  <div className="flex items-center justify-between mt-1.5 text-[10px] font-mono">
                    <span className="text-slate-400">Volume B:</span>
              ...
              <div className="space-y-2">
                <span className="text-xs font-bold text-slate-200 block">Combination Mode:</span>
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-center">
                  {[
                    { id: 'mix', label: '1. Mix / Layer', desc: 'Parallel layering' },
                    { id: 'append_sequential', label: '2. Append', desc: 'Append A ➔ B' },
                    { id: 'prepend_sequential', label: '3. Prepend', desc: 'Prepend B ➔ A' },
                    { id: 'crossfade_morph', label: '4. Morph Crossfade', desc: 'Smooth crossfade' },
                  ].map((mode) => (
                    <button
                      key={mode.id}
              ...
              {(mergeMode === 'append_sequential' || mergeMode === 'prepend_sequential') && (
                <div className="grid grid-cols-2 gap-3 pt-2 border-t border-[#1c293a] font-mono text-[10.5px]">
                  <div>
                    <div className="flex justify-between mb-1">
                      <span className="text-slate-400">Crossfade Transition:</span>
                  ...
                  <div>
                    <div className="flex justify-between mb-1">
                      <span className="text-slate-400">Silence Gap:</span>
        ...
        {activeTab === 'fades_retro' && (
          <div className="space-y-3">
            {/* Fade In & Out Studio */}
            <div className="bg-[#0e1624] p-3 rounded-xl border border-[#1e2d42] space-y-2.5">
              <span className="font-bold text-sky-300 font-mono block">Fade In / Fade Out Curves (Sample or Selection)</span>
              
              <div className="grid grid-cols-2 gap-2 text-[10.5px] font-mono">
                {/* Fade In */}
                <div className="bg-[#090e17] p-2 rounded-lg border border-[#162232] space-y-1.5">
                  <span className="font-bold text-emerald-400 block">FADE IN:</span>
                ...
                {/* Fade Out */}
                <div className="bg-[#090e17] p-2 rounded-lg border border-[#162232] space-y-1.5">
                  <span className="font-bold text-rose-400 block">FADE OUT:</span>
                  <div className="grid grid-cols-2 gap-1.5">
                    <button
              ...
              <div className="pt-1 flex items-center justify-between">
                ...
                >
                  Invert Phase (180° Polarity Flip)
                </button>
              </div>
            </div>
          ...
          <div className="space-y-3">
            ...
            <div className="bg-[#0e1624] p-3 rounded-xl border border-[#1e2d42] space-y-2.5">
              ...
              <div className="grid grid-cols-3 gap-2 text-[10.5px] font-mono">
                ...
                <div>
                  <label className="text-slate-400 block mb-1">Duration ({genDurationSec}s)</label>
                  <input
                    type="number"
                    min="0.1"
                    max="10"
